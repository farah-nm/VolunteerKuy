                            ...
                            @forelse ($users as $user)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.accounts.edit', $user->id) }}" class="text-indigo-600 hover:text-indigo-900">Ubah Status</a>
                                    </td>
                                </tr>
                            @empty
                                <tr><td class="px-6 py-4 whitespace-nowrap text-center" colspan="6">Tidak ada akun pengguna.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                    {{ $users->links() }} </div>
