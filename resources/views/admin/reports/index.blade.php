                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Organisasi Dilaporkan</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($reports as $report)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $report->organizationProfile->name ?? 'Tidak Diketahui' }}</td>
